...
import { Bell, Check, Eye, X, Archive, ArchiveX, Target, DollarSign, MessageSquare, Info, Signal, Banknote } from "lucide-react"; 
...
interface VaNotificationItem {
  ...
  timestamp: string;
  read: boolean;
  category: 'New Business Task' | 'Task Update' | 'Payment' | 'System Alert' | 'Student Message' | 'Live Task Available' | 'Payout Processed';
  link?: string;
...
const initialVaNotifications: VaNotificationItem[] = [
  ...
  { id: "VAN003", title: "Payout Processed: ₦10,000", description: "Your payout for completed tasks has been processed and sent to your bank.", timestamp: "2024-07-20 10:15 AM", read: true, category: "Payout Processed", link: "/va/payouts", icon: Banknote }, 
  { id: "VAN004", title: "Profile Tip: Add More Skills", description: "Consider adding more skills to your profile to attract a wider range of tasks.", timestamp: "2024-07-19 09:00 AM", read: true, category: "System Alert", icon: Info, link:"/va/profile" },
...
function getVaCategoryBadgeVariant(category: VaNotificationItem['category']) {
    switch (category) {
        ...
        case 'Payment': return 'bg-green-100 text-green-700 hover:bg-green-200'; // Keep for generic payment updates if needed
        case 'Payout Processed': return 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200'; // More specific for payouts
